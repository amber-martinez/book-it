...
function Homepage() {
    ...
    return (
        <div style={{ textAlign: 'center' }} className='hidden'>
            ...
            :
            <div>
                <Link to='/signup' style={{ textDecoration: 'none' }}><img src={icon ? 'https://i.imgur.com/ingObRo.png' : 'https://i.imgur.com/Bdz005N.png' } alt='all your bookmarks, one place' style={{ height: 505, marginTop: 84 }}></img></Link>
                <br></br>
