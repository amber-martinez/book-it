...
function NewListTheme({ primColor, setPrimColor, secColor, setSecColor, bulletIcon, setBulletIcon }) {
    ...
    return (
        <div style={{ display: 'inline-block'}}>
            <h6>Theme</h6>
            <Row style={{ marginBottom: 5, textAlign: 'left', marginTop: 25 }}>
                <Col>
                    <p>Primary color</p>
                </Col>
                <Col>
            ...
            <Row style={{ marginBottom: 5, textAlign: 'left' }}>
                <Col>
                    <p>Secondary color</p>
                </Col>
                <Col>
            ...
            <Row style={{ marginBottom: 5, textAlign: 'left' }}>
                ...
                <div style={{ textAlign: 'center' }}>
                    <button  onClick={onThemeSave} style={{ backgroundColor: '#7e857d', border: 'solid 1px #7e857d', borderColor: '#657065d9', textAlign: 'center', fontSize: 12, marginTop: 10, display: 'inline-block', marginLeft: 10, borderRadius: 3, color: 'white', padding: '2px 10px 3px 10px' }}>Save edits</button>
                </div>
